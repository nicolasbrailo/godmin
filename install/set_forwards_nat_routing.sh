...
chmod +x $IF_UP_HOOK
chmod 774 $FWDS_SCRIPT_FILE $BLOCKS_SCRIPT_FILE $START_FWDS_SCRIPT_FILE $RESTART_SCRIPT 
chgrp $GROUP $FWDS_SCRIPT_FILE $BLOCKS_SCRIPT_FILE $START_FWDS_SCRIPT_FILE $RESTART_SCRIPT 
